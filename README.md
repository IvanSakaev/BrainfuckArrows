...
**Дискорд публикация:** https://discord.com/channels/1139657094459560006/1459124942368149579
...
Некоторые красные стрелочки заменены на синие, уменьшено общее количество стрелочек.

### Предыдущие версии:

**1.1:** Самая первая версия. Добавлен сам интерпретатор и программа для конвертации brainfuck кода в стрелочки.
